...
production_steps=1000000 # Total number of steps
...
ff_para = 'input_files/stats_module.dat'
aalist={}
...
hoomd.dump.dcd(fileroot+'_dump.gsd', period=100000, group=all, overwrite=False)
