...
if __name__=='__main__':
    ...
    # print(f"The particle 507::{pos_chain_3[52]}")
    # exit()
    ...
    bond_length = 0.381
    box_length = bond_length * prot_length + 10    # 650 box size works
    print(box_length)
    print(prot_length)
    ...
    with gsd.hoomd.open(name= output_files , mode='wb') as f:
        f.append(snap)
        f.close()
        exit()
...
#     #print(snap.particles.position)
    hoomd.dump.gsd('FUS_initial_snapshot.gsd', period=1, group=all_group, overwrite=True, truncate=True)
