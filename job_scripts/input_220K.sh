...
#SBATCH -J FUS_220K      # Job name
#SBATCH -o fus_220K_%j.out       # Specify stdout output file (%j expands to jobId)
...
srun python3 simulation_run.py -dt="0.001" -time="10000000" -temp="220"  #input/FUS_LC.dat $i
