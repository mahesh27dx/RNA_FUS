...
#SBATCH -J FUS_340K      # Job name
#SBATCH -o fus_340K_%j.out       # Specify stdout output file (%j expands to jobId)
...
srun python3 simulation_run.py -dt="0.001" -time="20000000" -temp="340" -period="20000" #input/FUS_LC.dat $i
# srun python3 rna_sim_run.py -dt="0.001" -time="20000000" -temp="340" -period="20000"
