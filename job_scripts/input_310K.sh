...
#SBATCH -J FUS_310K      # Job name
#SBATCH -o fus_310K_%j.out       # Specify stdout output file (%j expands to jobId)
...
srun python3 simulation_run.py -dt="0.001" -time="10000000" -temp="310"  #input/FUS_LC.dat $i
