...
#SBATCH -J FUS_230K      # Job name
#SBATCH -o fus_230K_%j.out       # Specify stdout output file (%j expands to jobId)
...
srun python3 simulation_run.py -dt="0.001" -time="20000000" -temp="230" -period="20000" #input/FUS_LC.dat $i
# srun python3 rna_sim_run.py -dt="0.001" -time="20000000" -temp="230" -period="20000"
