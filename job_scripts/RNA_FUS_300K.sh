...
#SBATCH -J RNA_300K_FUS      # Job name
#SBATCH -o rna_300K_fus_%j.out       # Specify stdout output file (%j expands to jobId)
...
srun python3 rna_sim_run.py -dt="0.01" -time="100000000" -temp="300" -period="100000"
