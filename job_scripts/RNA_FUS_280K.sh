...
#SBATCH -J RNA_280K_FUS      # Job name
#SBATCH -o rna_280K_fus_%j.out       # Specify stdout output file (%j expands to jobId)
...
srun python3 rna_sim_run.py -dt="0.01" -time="10000000" -temp="280" -period="10000"
