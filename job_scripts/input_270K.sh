...
#SBATCH -J FUS_270K      # Job name
#SBATCH -o fus_270K_%j.out       # Specify stdout output file (%j expands to jobId)
...
srun python3 simulation_run.py -dt="0.001" -time="10000000" -temp="270"  #input/FUS_LC.dat $i
