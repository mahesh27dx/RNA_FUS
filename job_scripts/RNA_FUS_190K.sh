...
#SBATCH -J RNA_190K_FUS      # Job name
#SBATCH -o rna_190K_fus_%j.out       # Specify stdout output file (%j expands to jobId)
...
srun python3 rna_sim_run.py -dt="0.01" -time="10000" -temp="190" -period="10000"
