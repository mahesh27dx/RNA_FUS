...
#SBATCH -J RNA_260K_FUS      # Job name
#SBATCH -o rna_260K_fus_%j.out       # Specify stdout output file (%j expands to jobId)
...
srun python3 rna_sim_run.py -dt="0.01" -time="10000000" -temp="260" -period="10000"
