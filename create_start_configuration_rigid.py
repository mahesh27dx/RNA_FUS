...
if __name__=='__main__':
    ...
    s.particles.N = len(s.particles.position)  # (FUS_length-86)
    ...
    # s.particles.mass = [np.sum(FUS_mass[284:371]) , np.sum(FUS_mass[421:454])] + FUS_mass[:284] + FUS_id[371:421] + FUS_id[453:]
